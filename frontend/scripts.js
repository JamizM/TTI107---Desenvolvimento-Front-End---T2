...
const showWeatherOnScreen = (response) => {
    ...
    document.querySelector('.temperatura').innerHTML = `${response["temperature"].toFixed(0)}°C`; /*a função tofixed é para determinar quantos numeros apos a virgulaqueremos, como a gnt nao quer nenhum numero apos a virgula a gente deixa o tofixed como 0*/
